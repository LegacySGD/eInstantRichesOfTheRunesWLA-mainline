...
public class RichesOfTheRunesWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(RichesOfTheRunesWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/RichesOfTheRunesWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/RichesOfTheRunesWLAIW/InitOutcome.xml").getDocumentElement();
